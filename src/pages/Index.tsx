...
const HOME_BG = CITIES.find((c) => c.slug === 'novorossiysk')?.bgImage;
...
const REVIEWS = [
  {
    name: 'Игорь Соколов',
    role: 'ИП, сфера услуг',
    text: 'Обратился в «ЧекДок», когда срочно понадобились закрывающие документы после командировки. Сделали всё за пару часов, оформление аккуратное, вопросов у бухгалтерии не возникло.',
    rating: 5,
  },
  {
    ...
    <div className="relative min-h-screen text-foreground font-sans antialiased selection:bg-accent selection:text-accent-foreground">
        ...
        <div className="container grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="mt-8 max-w-md text-lg text-muted-foreground animate-fade-up" style={{ animationDelay: '0.1s', opacity: 0 }}>
              ...
              <br />
              Гостиничные, кассовые и товарные чеки, чеки за проживание, ресторанные чеки, чеки АЗС, счёт-фактуры, товарные накладные Торг-12 и акты выполненных работ в Новороссийске.
              <br />
              Также работаем в Майкопе, Набережных Челнах, Альметьевске, Нижнекамске, Петрозаводске, Адлере и Новошахтинске.
            </p>
          ...
          <div className="lg:col-span-5 animate-fade-up" style={{ animationDelay: '0.15s', opacity: 0 }}>
            <div className="relative mx-auto max-w-xs">
              ...
              <div className="relative bg-card border border-border rounded-sm p-6 font-mono text-xs text-foreground shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)] -rotate-1">
                ...
                <p className="text-center text-muted-foreground mb-4">№ 0042 · Новороссийск</p>
      ...
      <section id="about" className="py-24 border-t border-border">
        <div className="container grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6 text-muted-foreground text-lg">
            <p>
              «ЧекДок» — небольшая мастерская в Новороссийске. Мы оформляем товарные и кассовые чеки, помогаем с сопроводительными документами для отчётности и закрытия сделок.
            </p>
            <p>
              Гостиничные чеки в Новороссийске, отчётные документы за проживание через отель.
            </p>
            <p>
      ...
      <section id="delivery" className="py-24">
        <div className="container">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-muted-foreground">
            <span className="flex items-center gap-2"><Icon name="Truck" size={18} className="text-accent" /> Курьер по Новороссийску</span>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 bg-blue-900 text-white px-4 py-3 rounded-full shadow-lg hover:brightness-110 transition-all hover:scale-105 font-medium text-sm"
        >
